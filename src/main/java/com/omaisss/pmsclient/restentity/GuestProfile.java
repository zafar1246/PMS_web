...
public class GuestProfile extends BaseEntity {
	...
	@Column(name = "guest_profile_source_id")
	...
	@Column(name = "guest_profile_status")
	...
	public GuestProfile(int guestProfileId, int folioNo, int guestProfileSourceId, int contractProfileId, int titleId,
	...
	public String toString() {
		return "GuestProfile [guestProfileId=" + guestProfileId + ", folioNo=" + folioNo + ", guestProfileSourceId="
				...
				+ guestProfileStatus + ", remarks=" + remarks + ", is_contract=" + isContract + "]";
	}
